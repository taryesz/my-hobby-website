// WPISANIE IMIENIA W NAGLOWKU

// function changeTitle(sS) {
//     let naglowek = document.getElementsByClassName("header__title")[0];
//     naglowek.innerHTML = "Witaj na Projekcie, " + sS.getItem("imie");
// }

// if(sessionStorage.length == 0) {
//     let imie = prompt("Jak masz na imię?");
//     if(imie == null) {
//         sessionStorage.setItem("imie", "anonymous guy");
//     } else if(imie == "") {
//         sessionStorage.setItem("imie", "anonymous guy");
//     } else {
//         let imie_wartosc = String(imie);
//         sessionStorage.setItem("imie", imie_wartosc);    
//     }
//     changeTitle(sessionStorage);
// } else {
//     changeTitle(sessionStorage);
// }
